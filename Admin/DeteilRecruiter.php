...
<div class="login">
                <table width="100%" border="1" cellspacing="2" cellpadding="2">
                  ...
                  <tr>
                    <td><strong><a href="ApprovRecruiter.php?RecId=<?php echo $row['RecruiterId'];?>">Approv Recruiter</a></strong></td>
                    <td><strong><a href="RejectRecruiter.php?RecId=<?php echo $row['RecruiterId'];?>">Reject Recruiter</a></strong></td>
                  </tr>
                </table>
                </div>
                </div>
