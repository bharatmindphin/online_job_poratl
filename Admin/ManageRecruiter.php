...
<p class="nav"> Career Options Portal</p>
    ...
    <div class="col-div-12">
		<div class="box-9" style="padding-top: 30px; padding-left: 10px; height:50%;">
            ...
            <table style="width: 100%;" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    <td><table style="width: 100%;" border="1" bordercolor="#1CB5F1" >
                        <tr>
...
?>
                        <tr>
                          ...
                          <td class="style3"><div align="left" class="style9 style5"><strong><a href="DeteilRecruiter.php?RecId=<?php echo $Id;?>">Detail</a></strong></div></td>
                        </tr>
<?php
}
